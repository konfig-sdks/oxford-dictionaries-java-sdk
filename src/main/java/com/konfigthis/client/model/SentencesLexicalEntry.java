...
public class SentencesLexicalEntry {
  ...
  private List<ExamplesListInner> sentences = new ArrayList<>();
  ...
  public SentencesLexicalEntry grammaticalFeatures(List<GrammaticalFeaturesListInner> grammaticalFeatures) {
  ...
  public SentencesLexicalEntry addGrammaticalFeaturesItem(GrammaticalFeaturesListInner grammaticalFeaturesItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A linguistic category of words (or more precisely lexical items), generally defined by the syntactic or morphological behaviour of the lexical item in question, such as noun or verb")
  ...
  public SentencesLexicalEntry sentences(List<ExamplesListInner> sentences) {
  ...
  public SentencesLexicalEntry addSentencesItem(ExamplesListInner sentencesItem) {
  ...
  **/
  ...
  public List<ExamplesListInner> getSentences() {
    return sentences;
  }


  public void setSentences(List<ExamplesListInner> sentences) {
  ...
  **/
   ...
   * @return the SentencesLexicalEntry instance itself
   */
  public SentencesLexicalEntry putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.grammaticalFeatures, sentencesLexicalEntry.grammaticalFeatures) &&
        ...
        Objects.equals(this.additionalProperties, sentencesLexicalEntry.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(grammaticalFeatures, language, lexicalCategory, sentences, text, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SentencesLexicalEntry
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SentencesLexicalEntry.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SentencesLexicalEntry is not found in the empty JSON string", SentencesLexicalEntry.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SentencesLexicalEntry.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraysentences.size(); i++) {
        ExamplesListInner.validateJsonObject(jsonArraysentences.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SentencesLexicalEntry.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SentencesLexicalEntry' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SentencesLexicalEntry> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SentencesLexicalEntry.class));

       return (TypeAdapter<T>) new TypeAdapter<SentencesLexicalEntry>() {
           @Override
           public void write(JsonWriter out, SentencesLexicalEntry value) throws IOException {
           ...
           @Override
           public SentencesLexicalEntry read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SentencesLexicalEntry instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SentencesLexicalEntry given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SentencesLexicalEntry
  * @throws IOException if the JSON string is invalid with respect to SentencesLexicalEntry
  */
  public static SentencesLexicalEntry fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SentencesLexicalEntry.class);
  }

 /**
  * Convert an instance of SentencesLexicalEntry to an JSON string
  *
  * @return JSON string
  */
