 ...
 */
@ApiModel(description = "Description of an entry for a particular part of speech and grammatical features")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class LemmatronLexicalEntry {
  ...
  private List<InflectionsListInner> inflectionOf = new ArrayList<>();
  ...
  public LemmatronLexicalEntry grammaticalFeatures(List<GrammaticalFeaturesListInner> grammaticalFeatures) {
  ...
  public LemmatronLexicalEntry addGrammaticalFeaturesItem(GrammaticalFeaturesListInner grammaticalFeaturesItem) {
  ...
  **/
  ...
  public LemmatronLexicalEntry inflectionOf(List<InflectionsListInner> inflectionOf) {
  ...
  public LemmatronLexicalEntry addInflectionOfItem(InflectionsListInner inflectionOfItem) {
  ...
  **/
  ...
  public List<InflectionsListInner> getInflectionOf() {
    return inflectionOf;
  }


  public void setInflectionOf(List<InflectionsListInner> inflectionOf) {
  ...
  **/
   ...
   * @return the LemmatronLexicalEntry instance itself
   */
  public LemmatronLexicalEntry putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.grammaticalFeatures, lemmatronLexicalEntry.grammaticalFeatures) &&
        ...
        Objects.equals(this.additionalProperties, lemmatronLexicalEntry.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(grammaticalFeatures, inflectionOf, language, lexicalCategory, text, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("inflectionOf");
    ...
    openapiRequiredFields.add("inflectionOf");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LemmatronLexicalEntry
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LemmatronLexicalEntry.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LemmatronLexicalEntry is not found in the empty JSON string", LemmatronLexicalEntry.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LemmatronLexicalEntry.openapiRequiredFields) {
      ...
      // ensure the json data is an array
      if (!jsonObj.get("inflectionOf").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `inflectionOf` to be an array in the JSON string but got `%s`", jsonObj.get("inflectionOf").toString()));
      }

      JsonArray jsonArrayinflectionOf = jsonObj.getAsJsonArray("inflectionOf");
      // validate the required field `inflectionOf` (array)
      for (int i = 0; i < jsonArrayinflectionOf.size(); i++) {
        InflectionsListInner.validateJsonObject(jsonArrayinflectionOf.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LemmatronLexicalEntry.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LemmatronLexicalEntry' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LemmatronLexicalEntry> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LemmatronLexicalEntry.class));

       return (TypeAdapter<T>) new TypeAdapter<LemmatronLexicalEntry>() {
           @Override
           public void write(JsonWriter out, LemmatronLexicalEntry value) throws IOException {
           ...
           @Override
           public LemmatronLexicalEntry read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LemmatronLexicalEntry instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LemmatronLexicalEntry given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LemmatronLexicalEntry
  * @throws IOException if the JSON string is invalid with respect to LemmatronLexicalEntry
  */
  public static LemmatronLexicalEntry fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LemmatronLexicalEntry.class);
  }

 /**
  * Convert an instance of LemmatronLexicalEntry to an JSON string
  *
  * @return JSON string
  */
