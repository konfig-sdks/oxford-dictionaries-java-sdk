...
import com.konfigthis.client.model.LanguagesResultsInner;
 ...
 */
@ApiModel(description = "Schema for the languages endpoint.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Languages {
  ...
  private List<LanguagesResultsInner> results = null;
  ...
  **/
  ...
  public Languages results(List<LanguagesResultsInner> results) {
  ...
  public Languages addResultsItem(LanguagesResultsInner resultsItem) {
  ...
  **/
  ...
  public List<LanguagesResultsInner> getResults() {
    return results;
  }


  public void setResults(List<LanguagesResultsInner> results) {
   ...
   * @return the Languages instance itself
   */
  public Languages putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.metadata, languages.metadata) &&
        ...
        Objects.equals(this.additionalProperties, languages.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Languages
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Languages.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("results") != null && !jsonObj.get("results").isJsonNull()) {
        ...
        if (jsonArrayresults != null) {
          ...
          for (int i = 0; i < jsonArrayresults.size(); i++) {
            LanguagesResultsInner.validateJsonObject(jsonArrayresults.get(i).getAsJsonObject());
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Languages>() {
           ...
           public Languages read(JsonReader in) throws IOException {
             ...
             Languages instance = thisAdapter.fromJsonTree(jsonObj);
