...
import com.konfigthis.client.model.LexicalEntry;
 ...
 */
@ApiModel(description = "Description of a word")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class HeadwordEntry {
  ...
  **/
  ...
  public HeadwordEntry pronunciations(List<PronunciationsListInner> pronunciations) {
  ...
  public HeadwordEntry addPronunciationsItem(PronunciationsListInner pronunciationsItem) {
  ...
  **/
   ...
   * @return the HeadwordEntry instance itself
   */
  public HeadwordEntry putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, headwordEntry.id) &&
        ...
        Objects.equals(this.additionalProperties, headwordEntry.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, language, lexicalEntries, pronunciations, type, word, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to HeadwordEntry
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!HeadwordEntry.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HeadwordEntry is not found in the empty JSON string", HeadwordEntry.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : HeadwordEntry.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraylexicalEntries.size(); i++) {
        LexicalEntry.validateJsonObject(jsonArraylexicalEntries.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HeadwordEntry.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HeadwordEntry' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HeadwordEntry> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HeadwordEntry.class));

       return (TypeAdapter<T>) new TypeAdapter<HeadwordEntry>() {
           @Override
           public void write(JsonWriter out, HeadwordEntry value) throws IOException {
           ...
           @Override
           public HeadwordEntry read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             HeadwordEntry instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of HeadwordEntry given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of HeadwordEntry
  * @throws IOException if the JSON string is invalid with respect to HeadwordEntry
  */
  public static HeadwordEntry fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HeadwordEntry.class);
  }

 /**
  * Convert an instance of HeadwordEntry to an JSON string
  *
  * @return JSON string
  */
