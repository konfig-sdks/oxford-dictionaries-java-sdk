...
import com.konfigthis.client.model.WordlistResultsInner;
 ...
 */
@ApiModel(description = "Schema for wordlist endpoint.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Wordlist {
  ...
  private List<WordlistResultsInner> results = null;

  public Wordlist() {
  }

  public Wordlist metadata(Object metadata) {
  ...
  **/
  ...
  public Wordlist results(List<WordlistResultsInner> results) {
  ...
  public Wordlist addResultsItem(WordlistResultsInner resultsItem) {
  ...
  **/
  ...
  public List<WordlistResultsInner> getResults() {
    return results;
  }


  public void setResults(List<WordlistResultsInner> results) {
   ...
   * @return the Wordlist instance itself
   */
  public Wordlist putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.metadata, wordlist.metadata) &&
        ...
        Objects.equals(this.additionalProperties, wordlist.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Wordlist
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Wordlist.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("results") != null && !jsonObj.get("results").isJsonNull()) {
        ...
        if (jsonArrayresults != null) {
          ...
          for (int i = 0; i < jsonArrayresults.size(); i++) {
            WordlistResultsInner.validateJsonObject(jsonArrayresults.get(i).getAsJsonObject());
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Wordlist>() {
           ...
           public Wordlist read(JsonReader in) throws IOException {
             ...
             Wordlist instance = thisAdapter.fromJsonTree(jsonObj);
