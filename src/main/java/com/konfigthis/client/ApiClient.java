...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://od-api-demo.oxforddictionaries.com:443/api/v1";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("appId", new ApiKeyAuth("header", "app_id"));
        authentications.put("appKey", new ApiKeyAuth("header", "app_key"));
        ...
        if (configuration != null) {
            ...
            if (configuration.appKey != null) {
                this.setAppKey(configuration.appKey);
            }
    ...
    public void setAppIdPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("appId")).setApiKeyPrefix(prefix);
    }
    public String getAppKey() {
        return ((ApiKeyAuth) this.getAuthentication("appKey")).getApiKey();
    }

    public void setAppKey(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("appKey")).setApiKey(apiKey);
    }

    public void setAppKeyPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("appKey")).setApiKeyPrefix(prefix);
    }
    ...
    private void init() {
        ...
        setUserAgent("Konfig/1.11.0/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://od-api-demo.oxforddictionaries.com:443/api/v1)
