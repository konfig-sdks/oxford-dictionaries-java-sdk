...
public class LexiStatsApiTest {
    ...
    private static LexiStatsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new LexiStatsApi(apiClient);
    }
     ...
     */
    @Test
    public void getNgramFrequenciesTest() throws ApiException {
        ...
        Long offset = null;
        Long limit = null;
        NgramsResult response = api.getNgramFrequencies(sourceLang, corpus, ngramSize)
                .tokens(tokens)
                .contains(contains)
     ...
     */
    @Test
    public void getWordFrequenciesTest() throws ApiException {
        String sourceLang = null;
        String corpus = null;
        ...
        Long offset = null;
        Long limit = null;
        StatsWordResultList response = api.getWordFrequencies(sourceLang)
                .corpus(corpus)
                .wordform(wordform)
                .trueCase(trueCase)
                .lemma(lemma)
    ...
    public void getWordFrequencyTest() throws ApiException {
        ...
        String lemma = null;
        String lexicalCategory = null;
        StatsWordResult response = api.getWordFrequency(sourceLang)
                .corpus(corpus)
                .wordform(wordform)
                .trueCase(trueCase)
                .lemma(lemma)
